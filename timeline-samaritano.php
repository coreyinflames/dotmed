            ...
            <div class="row">
              <div class="col-md-3">
                <div class="profile-info">
                  ...
                  <button onclick="location.href = 'timeline-book-samaritano.php'; "class="btn-primary"> Agendar Atendimento</button>
                </div>
              </div>
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  <li><a href="timeline-samaritano.html" class="active">Timeline</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-7 col-sm-7">
                    <div class="form-group">
                      ...
                      <textarea name="texts" id="exampleTextarea" cols="30" rows="1" class="form-control" placeholder="O que está pensando?"></textarea>
                    </div>
                  </div>
              ...
              <div class="post-content">
                ...
                <img src="images/samaritano-back.png" alt="post-image" class="img-responsive post-image" />
                <div class="post-container">
                  <img src="http://placehold.it/300x300" alt="user" class="profile-photo-md pull-left" />
                  <div class="post-detail">
                    <div class="user-info">
                      <h5><a href="timeline.html" class="profile-link">Samaritano</a> <span class="following">following</span></h5>
